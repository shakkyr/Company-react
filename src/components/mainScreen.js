      ...
      <section id="about-info" className="bg-light py-3">
        <div className="container">
          ...
          <div className="info-right">
            <img
              src="https://wallpaperbat.com/down/241932-open-banking-will-change-everythingeventually"
              alt="hotel"
            />
          </div>
        </div>
      ...
      <section id="testimonials" className="py-3">
        <div className="container">
          ...
          <div className="testimonial bg-primary">
            <img
              src="https://wallpaperbat.com/down/264163-fictitious-assets-ailing-irans-banking-sector"
              alt="Samantha"
            />
            <p>
          ...
          <div className="testimonial bg-primary">
            <img
              src="https://wallpaperbat.com/down/340169-reasons-you-hate-your-bank"
              alt="Jen"
            />
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam
